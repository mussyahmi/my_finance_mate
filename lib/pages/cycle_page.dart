...
class _CyclePageState extends State<CyclePage> {
  ...
  Future<void> initAsync() async {
    ...
    final savedSwitchBetweenCycles =
        sharedPreferences.getInt('switch_between_cycles');

    setState(() {
      prefs = sharedPreferences;
      switchBetweenCycles = savedSwitchBetweenCycles ?? 0;
    });
  }
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              if (context.watch<CyclesProvider>().cycles !=
                                  null)
                                TextButton(
                                    onPressed: () async {
                                      ...
                                      if (refreshSwitchBetweenCycles) {
                                        final savedSwitchBetweenCycles = prefs
                                            .getInt('switch_between_cycles');

                                        setState(() {
                                          switchBetweenCycles =
                                              savedSwitchBetweenCycles ?? 0;
                                        });
                                      }
                                    },
